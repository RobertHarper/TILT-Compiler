...
*)
    ...
    fun con2path c = 
      let fun loop c labs = (case C.expose c
			       of (Var_c v) => SOME(v,labs)
	...
	(case E.expose exp of
	   ...
	   | Const_e v => Ppprim.pp_value' (fn e => case E.expose e of (Const_e v) => SOME v | _ => NONE) pp_exp pp_con v
