(*$import CHAR INTEGER MATH IMPERATIVE_IO MONO_ARRAY MONO_VECTOR PRIM_IO REAL STREAM_IO STRING SUBSTRING TEXT_IO TEXT_STREAM_IO WORD ARRAY BIN_IO BOOL BYTE COMMAND_LINE DATE GENERAL IEEE_REAL IO_SIG LIST LIST_PAIR OPTION OS_SIG OS_FILE_SYS OS_IO OS_PATH OS_PROCESS SML90_SIG STRING_CVT TIME TIMER VECTOR TOP *)
