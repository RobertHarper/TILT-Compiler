structure NilPrimUtilParam
	...
	in
		...
		let val v = NilContextPre.find_labelled_var (context,unit_c)
		in  Proj_c (Proj_c(Var_c v, bool_mod), bool_lab)
		end
	    fun bool2exp context b =
		let val rv = NilContextPre.find_labelled_var (context,unit_r)
		    ...
		    val sum = Proj_c (Proj_c(Var_c cv, bool_mod), bool_sum_lab)
