...
***********************************************************)
   ...
   *)
   ...
   fun xHILctx HILctx =
	   ...
	   fun doext(v,l,il_type,(imports, context : splitting_context)) =
	   ...
	   fun folder (ent,acc) =
		  ...
		  | Il.CONTEXT_EXTERN (_,v,l,c) => doext(v,l,c,acc)
	...
	let
		...
		xsbnds initial_splitting_context [sbnd]
