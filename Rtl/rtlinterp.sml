functor Rtlinterp(structure Pprtl : PPRTL
 ...
 : RTLINTERP  = 
  struct
    ...
    val init_label_table = [(xML_EXTERN_LABEL "ml_output", 1000000),
			    (xML_EXTERN_LABEL "ml_input", 1000004),
			    (xML_EXTERN_LABEL "ml_lookahead", 1000008),
			    (xML_EXTERN_LABEL "ml_open_in", 1000012),
			    (xML_EXTERN_LABEL "ml_open_out", 1000016),
			    (xML_EXTERN_LABEL "ml_close_in", 1000020),
			    (xML_EXTERN_LABEL "ml_close_out", 1000024),
			    (xML_EXTERN_LABEL "ml_flush_out", 1000028),
			    (xML_EXTERN_LABEL "ml_end_of_stream", 1000032),
			    (xML_EXTERN_LABEL "ml_spill_vararg", 1000036)
			    ]
