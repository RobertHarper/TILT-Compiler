(*$import Prelude TopLevel List GlobalStructs PROVER METAGLOBAL METASYN INIT STRATEGY FILLING SPLITTING RECURSION QED METAPRINT NAMES TIMERS OrderStructs *)
(* Meta Prover *)
