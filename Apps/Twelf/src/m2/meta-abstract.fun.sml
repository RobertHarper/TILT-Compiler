(*$import Prelude TopLevel METAABSTRACT GLOBAL METASYN METAGLOBAL ABSTRACT MODESYN WHNF PRINT CONSTRAINTS UNIFY NAMES TRAIL TYPECHECK SUBORDINATE StreamStructs *)
(* Meta Abstraction *)
