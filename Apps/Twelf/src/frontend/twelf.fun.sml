(*$import Prelude TopLevel TextIO OS IO Int List Substring Char TWELF GLOBAL TIMERS INTSYN WHNF PRINT NAMES PATHS ORIGINS LEXER PARSING PARSER TYPECHECK CONSTRAINTS ABSTRACT TP_RECON MODESYN MODECHECK MODE_RECON MODEPRINT MODEDEC TERMINATE INDEX SUBORDINATE COMPSYN COMPILE TRAIL ABSMACHINE SOLVE THMSYN THM THM_RECON THMPRINT METAGLOBAL FUNSYN SKOLEM PROVER CLAUSEPRINT TRACE OpsemStructs *)
(* Front End Interface *)
