(*$import Prelude TopLevel List Int MTPSPLITTING MTPGLOBAL GLOBAL INTSYN FUNSYN STATESYN HEURISTIC MTPABSTRACT MTPRINT NAMES CONV WHNF TYPECHECK SUBORDINATE FUNTYPECHECK INDEX PRINT UNIFY LambdaStructs *)
