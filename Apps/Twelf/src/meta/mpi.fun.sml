(*$import Prelude TopLevel TextIO Int List MTPI MTPGLOBAL INTSYN FUNSYN STATESYN RELFUN FORMATTER PRINT FUNTYPECHECK MTPDATA MTPINIT MTPFILLING INFERENCE MTPSPLITTING MTPRECURSION MTPSTRATEGY MTPRINT TWELF_ORDER NAMES TIMERS RingStructs GlobalStructs *)
