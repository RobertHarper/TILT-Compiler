...
\describe{trap barriers}
  {Trap barrier primitives}
  {\mathsf{soft\_vtrap}(\ttt),
   \mathsf{soft\_ztrap}(\ttt),
   \mathsf{hard\_vtrap}(\ttt),
   \mathsf{hard\_ztrap}(\ttt)\quad
     \mbox{\ where\ } \ttt\in\{\mathcd{int\_tt},\mathcd{real\_tt},
                               \mathcd{both\_tt}\}}
...
\describe{numeric conversions}
   ...
   {\mathsf{float2int}(\expression),\ \mathsf{int2float}(\expression),\
    \mathsf{int2uint}_{b_1,b_2}(\expression),\ 
    \mathsf{uint2int}_{b_1,b_2}(\expression),\ 
...
\describe{floating-point primitives}
  {Primitives for floating-point operations}
  {\mathsf{neg\_float}_b(\expression),\
   \mathsf{abs\_float}_b(\expression),\
   \mathsf{plus\_float}_b(\expression_1,\expression_2),\
   \mathsf{minus\_float}_b(\expression_1,\expression_2),\
   \mathsf{mul\_float}_b(\expression_1,\expression_2),$ $
   \mathsf{div\_float}_b(\expression_1,\expression_2),\
   \mathsf{less\_float}_b(\expression_1,\expression_2),\
   \mathsf{greater\_float}_b(\expression_1,\expression_2),\
   \mathsf{lesseq\_float}_b(\expression_1,\expression_2),$ $
   \mathsf{greatereq\_float}_b(\expression_1,\expression_2),\
   \mathsf{eq\_float}_b(\expression_1,\expression_2),\
   \mathsf{neq\_float}_b(\expression_1,\expression_2)\
    \mbox{ where\ $b\in\{32,64\}$}}
  {Prim\_e(PrimOp(neg\_float $\translate{b}$), [], 
           [$\translate{\expression}$]),
   Prim\_e(PrimOp(abs\_float $\translate{b}$), [], 
           [$\translate{\expression}$]),
   Prim\_e(PrimOp(plus\_float $\translate{b}$), [], 
           [$\translate{\expression_1}$,$\translate{\expression_2}$]),
   Prim\_e(PrimOp(minus\_float $\translate{b}$), [], 
           [$\translate{\expression_1}$,$\translate{\expression_2}$]),
   Prim\_e(PrimOp(mul\_float $\translate{b}$), [], 
           [$\translate{\expression_1}$,$\translate{\expression_2}$]),
   Prim\_e(PrimOp(less\_float $\translate{b}$), [], 
           [$\translate{\expression_1}$,$\translate{\expression_2}$]),
   Prim\_e(PrimOp(greater\_float $\translate{b}$), [], 
           [$\translate{\expression_1}$,$\translate{\expression_2}$]),
   Prim\_e(PrimOp(lesseq\_float $\translate{b}$), [], 
           [$\translate{\expression_1}$,$\translate{\expression_2}$]),
   Prim\_e(PrimOp(greatereq\_float $\translate{b}$), [], 
           [$\translate{\expression_1}$,$\translate{\expression_2}$]),
   Prim\_e(PrimOp(eq\_float $\translate{b}$), [], 
           [$\translate{\expression_1}$,$\translate{\expression_2}$]),
   Prim\_e(PrimOp(neq\_float $\translate{b}$), [], 
           [$\translate{\expression_1}$,$\translate{\expression_2}$])}
  {}
  {We give the typing rules for representative primitives only}
  {\[
   \frac{\validexpression{\context}{\expression}{\cmilfloat{b}}}
        {\validexpression{\context}{\mathsf{neg\_float}_b(\expression)}
               {\cmilfloat{b}}}
   \qquad
   \frac{\validexpression{\context}{\expression}{\cmilfloat{b}}}
        {\validexpression{\context}{\mathsf{abs\_float}_b(\expression)}
               {\cmilfloat{b}}}
   \]
   \[
   \frac{\validexpression{\context}{\expression_1}{\cmilfloat{b}}
         \qquad
         \validexpression{\context}{\expression_2}{\cmilfloat{b}}}
        {\validexpression{\context}
            {\mathsf{plus\_float}_b(\expression_1,\expression_2)}
            {\cmilfloat{b}}}
   \]
...
\describe{Integer Primitives}
   {Primitives for integer operations}
   {\mathsf{neg\_int}_b(\expression),\
    \mathsf{abs\_int}_b(\expression),\
    \mathsf{plus\_int}_b(\expression_1,\expression_2),\
    \mathsf{minus\_int}_b(\expression_1,\expression_2),\
    \mathsf{mul\_int}_b(\expression_1,\expression_2),$ $
    \mathsf{div\_int}_b(\expression_1,\expression_2),\
    \mathsf{mod\_int}_b(\expression_1,\expression_2),\
    \mathsf{quot\_int}_b(\expression_1,\expression_2),\
    \mathsf{rem\_int}_b(\expression_1,\expression_2),$ $
    \mathsf{plus\_uint}_b(\expression_1,\expression_2),\
    \mathsf{minus\_uint}_b(\expression_1,\expression_2),\
    \mathsf{div\_uint}_b(\expression_1,\expression_2),\
    \mathsf{mod\_uint}_b(\expression_1,\expression_2),$ $
    \mathsf{less\_int}_b(\expression_1,\expression_2),\
    \mathsf{greater\_int}_b(\expression_1,\expression_2),\
    \mathsf{lesseq\_int}_b(\expression_1,\expression_2),\
    \mathsf{greatereq\_int}_b(\expression_1,\expression_2),$ $
    \mathsf{less\_uint}_b(\expression_1,\expression_2),\
    \mathsf{greater\_uint}_b(\expression_1,\expression_2),\
    \mathsf{lesseq\_uint}_b(\expression_1,\expression_2),\
    \mathsf{greatereq\_uint}_b(\expression_1,\expression_2),$ $
    \mathsf{eq\_int}_b(\expression_1,\expression_2),\
    \mathsf{neq\_int}_b(\expression_1,\expression_2),\ 
    \mathsf{not\_int}_b(\expression),\
    \mathsf{and\_int}_b(\expression_1,\expression_2),\ 
    \mathsf{or\_int}_b(\expression_1,\expression_2),$ $ 
    \mathsf{xor\_int}_b(\expression_1,\expression_2),\ 
    \mathsf{lshift\_int}_b(\expression_1,\expression_2),\ 
    \mathsf{rshift\_int}_b(\expression_1,\expression_2),\ 
    \mathsf{rshift\_uint}_b(\expression_1,\expression_2),$ $ 
     \mbox{where $b\in\{8,16,32\}$}}
