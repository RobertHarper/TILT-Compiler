(*$import Word8 String Byte Option Word32 Array Vector Word8Vector CharVector CRC Char BinIO CharArray BinIoUtil *)
...
structure Crc :> CRC =
  struct
    ...
    local val ti = Word32.toInt
          val fi = Word32.fromInt
    in
      val andb_ : int -> int -> int = fn a => fn b => ti(Word32.andb(fi a,fi b))
      val xorb_ : int -> int -> int = fn a => fn b => ti(Word32.xorb(fi a,fi b))
