(*$import ORD_MAP BinaryMapFn Util MACHINE *)
functor Regmap (structure Machine : sig datatype register = R of int | F of int end)
  :> ORD_MAP where type Key.ord_key = Machine.register =
struct
  local 
